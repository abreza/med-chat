...
from ...core.config.constants import AVAILABLE_MODELS
...
def create_llm_settings() -> Dict[str, Any]:    
    ...
    return {
        ...
        "change_llm_btn": change_llm_btn,
    }


def create_asr_settings(language_options: List[Tuple[str, str]], 
                       default_language: str = "fa", 
                       default_region: str = None) -> Dict[str, Any]:    
    gr.HTML("<hr>")
...
def create_tts_settings(language_options: List[str], 
                       voice_options: List[Tuple[str, str]],
                       default_voice: str = None) -> Dict[str, Any]:    
    gr.HTML("<hr>")
    ...
    return {
        "tts_language_filter": tts_language_filter,
        "tts_voice_dropdown": tts_voice_dropdown,
        "tts_speaker_slider": tts_speaker_slider,
        "tts_speed_slider": tts_speed_slider,
        "tts_noise_scale_slider": tts_noise_scale_slider,
        "tts_noise_scale_w_slider": tts_noise_scale_w_slider,
        "speaker_info": speaker_info,
        "apply_tts_btn": apply_tts_btn,
        "test_tts_btn": test_tts_btn,
        "test_audio": test_audio,
    }


def create_settings_panel(language_options: List[Tuple[str, str]], 
                         tts_language_options: List[str],
                         voice_options: List[Tuple[str, str]],
                         default_language: str = "fa",
    ...
    with gr.Accordion("⚙️ Settings", open=False):
        ...
        asr_components = create_asr_settings(language_options, default_language, default_region) 
        tts_components = create_tts_settings(tts_language_options, voice_options, default_voice)
