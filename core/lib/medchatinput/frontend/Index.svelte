...
<script context="module" lang="ts">
	export { default as BaseMultimodalTextbox } from "./MultimodalTextbox.svelte";
...
<script lang="ts">
	...
	export let transcription_language: string | null = null;
	export let transcription_region: string | null = null;
